package ec.backend.reactive.talentzone.playlist.router;

import ec.backend.reactive.talentzone.playlist.usecases.*;
import ec.backend.reactive.talentzone.playlist.dto.PlaylistDTO;
import ec.backend.reactive.talentzone.song.usecases.GetSongByIdUseCase;
...
public class PlaylistRouter {
    ...
    @Bean
    public RouterFunction<ServerResponse> deletePlaylistRouter(DeleteProductoByUseCase deletePlaylistUseCase){
